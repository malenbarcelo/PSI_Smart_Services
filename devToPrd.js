...
var prdDominioFile = devDominioFile.replaceAll('http://localhost:3000','https://psi-smart-services.wnpower.host')
...
prdDominioFile = devDominioFile.replaceAll('http://localhost:3000','https://psi-smart-services.wnpower.host')
fs.writeFileSync(dominio,prdDominioFile)
...
//prdConfigFile = prdConfigFile.replaceAll('davDatabase','psismart_psi_db')// In case devToPrd.js is run twice
