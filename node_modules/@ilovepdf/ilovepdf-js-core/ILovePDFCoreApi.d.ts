...
declare const _default: {
    ...
    getSignatureList: (auth: Auth, xhr: XHRInterface, page?: number, pageLimit?: number) => Promise<GetSignatureStatus[]>;
...
export declare type GetSignatureStatus = {
...
export declare type GetReceiverInfoResponse = {
    uuid: string;
    name: string;
    email: string;
