...
export default class Receiver {
    ...
    addFile(file: SignatureFile): void;
    toJSON(): ToJson;
}
export declare type ReceiverParams = {
    phone?: string;
    /**
    * Receiver type.
    */
 ...
 */
declare type ReceiverType = 'signer' | 'validator' | 'witness';
/**
 ...
 */
declare type SignatureType = 'all' | 'text' | 'sign' | 'image';
declare type ToJson = {
    /**
     * Signer full name.
     */
