        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [2 /*return*/, this.xhr.post(globals_json_1.default.API_URL_PROTOCOL + "://" + globals_json_1.default.API_URL + "/" + globals_json_1.default.API_VERSION + "/task", __assign({ secret_key: this.auth.secretKey }, params), {
                                headers: [
